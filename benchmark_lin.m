...
% Script pour comparer le VKF et un filtre particulaire dans un environnement linéaire
...
particles = rand(num_particles, 1) * 2 - 1; % on initialise des particules entre -1 et 1
...
for t = 1:T
    ...
    likelihoods = normpdf(observations(t), particles, sqrt(sigma2));
